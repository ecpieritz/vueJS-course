<template>
    <div class="container">
        ...
        <p>Possui <strong>{{ idade }}</strong> anos</p>
        <button @click="changeName">Alterar Nome</button>
        <hr>
        <div class="componentes">
            <app-usuario-info :nome="nome" :idade='idade' @nomeMudou="nome = $event" :restartFn='restartName' />
            <app-usuario-editar :idade='idade' @ageChanged="idade = $event" />
        </div>
    </div>
</template>
