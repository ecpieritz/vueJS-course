...
export default {
	...
	methods: {
		save(){
			axios.post('https://curso-vue-e9fc3-default-rtdb.firebaseio.com/users.json', this.user).then(answer =>{
				this.user.name = ''
				this.user.email = ''
        ...
        //como está abaixo, é o mesmo que se colocasse .get após $http
				axios('https://curso-vue-e9fc3-default-rtdb.firebaseio.com/users.json').then(answer =>{
